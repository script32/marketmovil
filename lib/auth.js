...
const restrictedRoutes = [
    ...
    { route: '/admin/stores/new', response: 'redirect' },
    { route: '/admin/stores/insert', response: 'redirect' },
    { route: '/admin/stores/update', response: 'redirect' },
    ...
    { route: '/admin/file/upload/stores', response: 'json' }
];
